...
const styles = {
  // Adicionamos color: '#333' aqui e no card!
  container: { padding: '20px', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto', color: '#ffffff' },
  card: { border: '1px solid #ddd', borderRadius: '8px', padding: '15px', marginBottom: '20px', backgroundColor: '#f9f9f9', color: '#333' },
  ...
  return (
    <div style={styles.container}>
      ...
      <section style={{ ...styles.card, textAlign: 'center' }}>
        <h2 style={{ color: 'black' }}>Etapa Atual: {aulas[etapa].title}</h2> {/* Modificado, o title estava com cor invisivel a olho nú. HEHE!! */}
...
const Quiz = () => {
  ...
  return (
    <section style={{...styles.card, backgroundColor: '#e3f2fd', textAlign: 'center'}}>
      ...
      {/* O botão agora inverte o estado atual e muda o próprio texto! */}
      <button 
      ...
      {/* A resposta só aparece se 'respondido' for verdadeiro */}
